      ...
      {!isMenuOpen && (
        ...
        >
          <img
            src={logokembali}
            alt="Kembali"
            className="w-10 md:w-10 h-10 md:h-10 text-orange-400"
          />
        </button>
      )}
      ...
      <main className="bg-white rounded-lg shadow-lg mt-8 p-6 w-4/5">
        <article>
          <h2 className="text-3xl font-bold text-gray-800 mb-4 leading-snug">
            ESDM Sebut Hanya 2 dari 13 Industri Bioetanol yang Penuhi Kriteria
            Fuel Grade
          </h2>
          ...
          <p className="text-gray-700 mb-6 leading-relaxed">
            ...
            hanya dua dari 13 industri bioetanol di Indonesia yang memenuhi
            kriteria fuel grade. Industri ini penting untuk mendukung
            pencampuran energi terbarukan.
          </p>
          <img
            src={beritaImage2}
            alt="Fuel Grade"
          ...
          <p className="text-gray-700 leading-relaxed">
            Bioetanol fuel grade merupakan salah satu komponen bahan bakar
            nabati yang dapat dicampur dengan bahan bakar fosil untuk mengurangi
            emisi karbon. Pemerintah berencana meningkatkan kapasitas industri
            bioetanol ini untuk mendukung kebutuhan energi berkelanjutan.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-lg shadow-md p-4">
            ...
            <h4 className="mt-4 font-semibold">
              {" "}
              Potensi Bioenergi Indonesia Melimpah, Sumber Alternatif Pembangkit
              Listrik
            </h4>
