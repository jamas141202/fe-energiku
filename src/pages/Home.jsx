...
import Image11 from "../assets/dummy1.png";
import Image12 from "../assets/dummy2.png";
import Image13 from "../assets/dummy3.png";
import Image14 from "../assets/dummy4.png";
import Image15 from "../assets/dummy5.png";
import Image16 from "../assets/dummy6.png";
import Image17 from "../assets/dummy7.png";
  ...
  return (
    <div>
      ...
      <div>
        ...
        <motion.div
          ref={ref1}
          className="p-4 sm:p-6 md:p-12 lg:px-32 rounded-lg grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-12 lg:gap-32 mt-8 sm:mt-12 md:mt-24"
          initial="hidden"
        ...
        >
          ...
          <motion.div
            ...
            transition={{ duration: 2 }}
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-2 sm:mb-3 md:mb-5">
              Bio Energi
            </h2>
            <p className="text-sm sm:text-base md:text-lg text-gray-900 font-normal">
        ...
        <motion.div
          ref={ref2}
          className="p-4 sm:p-6 md:p-12 lg:px-32 rounded-lg shadow-lg grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 mt-6 sm:mt-8"
          initial="hidden"
