...
function Detailmitra() {
  ...
  return (
    <div className="mt-[100px] md:mt-[100px] flex flex-col items-center px-4 md:px-0">
      ...
      {/* Bingkai Konten */}
      <div className="mt-8 mb-8 border-4 border-[#E34A2B] px-4 sm:px-8 py-6 w-full max-w-[1150px] rounded-3xl">
        {/* Judul */}
        <h1 className="text-[#EE9F26] text-2xl sm:text-4xl font-bold text-left mt-9">
          Berminat menjadi bagian dari{" "}
          <span className="text-[#275A53]">EnergiKu</span>?
        </h1>
        <h2 className="text-[#EE9F26] text-xl sm:text-2xl font-bold text-left mt-4 mb-6">
        ...
        <form className="flex flex-col gap-4 sm:gap-6">
          {/* Nama Pendaftar */}
          <label className="text-gray-700 text-lg sm:text-xl font-semibold">
            Nama Pendaftar:
            <input
              type="text"
              className="mt-2 w-full border border-gray-300 rounded-lg px-3 sm:px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#E34A2B]"
          ...
          <label className="text-gray-700 text-lg sm:text-xl font-semibold">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-2 items-center">
              <input
                type="number"
                className="w-full sm:w-40 border border-gray-300 rounded-lg px-3 sm:px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#E34A2B]"
                placeholder="kg/L"
              />
              <input
                type="text"
                className="w-full sm:w-64 border border-gray-300 rounded-lg px-3 sm:px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#E34A2B]"
